...
let _locale = localStorage.getItem(LOCALSTORAGE_LANGUAGE)
...
export function setLocale(locale) {
  ...
  localStorage.setItem(LOCALSTORAGE_LANGUAGE, resolvedLocale !== "ja" ? resolvedLocale : "jp");
...
const interval = window.setInterval(() => {
  if (window.APP && window.APP.store) {
    ...
    const locale = localStorage.getItem(LOCALSTORAGE_LANGUAGE)
      ? localStorage.getItem(LOCALSTORAGE_LANGUAGE)
      : window.APP.store.state.preferences.locale;
    setLocale(locale);
